...
public class ViewDragHelper {
    ...
    //add by Komi--------------------------------------------------
    public boolean smoothSlideViewTo(View child, int startLeft, int startTop, int finalLeft, int finalTop) {
        mCapturedView = child;
        mActivePointerId = INVALID_POINTER;
    ...
    private boolean forceSettleCapturedViewAt(int startLeft, int startTop, int finalLeft, int finalTop, int xvel, int yvel) {
        final int dx = finalLeft - startLeft;
        final int dy = finalTop - startTop;
